const { SlashCommandBuilder, ContainerBuilder, SectionBuilder, TextDisplayBuilder, ThumbnailBuilder, MediaGalleryBuilder } = require('discord.js');

const { EmbedBuilder } = require('./v2EmbedBuilder');
...
function buildImageEffectCommand(config) {
  ...
  return {
    ...
    async execute(interaction) {
      ...
      await interaction.editReply({ flags: 32768, components: [embed] });
    },
  };
}
